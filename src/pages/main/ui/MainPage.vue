...
<template>
  <div class="main-page h-screen flex flex-col">
    ...
    <div class="flex-1 overflow-hidden">
      ...
      >
        <div class="editors-section h-1/2 flex gap-4 p-4 border-b">
          <div class="editor-container flex-1 flex flex-col rounded-lg border bg-white dark:bg-gray-900">
        ...
        <div class="results-section h-1/2 flex flex-col">
      ...
      >
        <div class="flex-1 min-w-0 rounded-lg border bg-white dark:bg-gray-900 flex flex-col">
